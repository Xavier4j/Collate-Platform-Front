<template>
  <v-container>
    <v-chip class="ma-2" color="red" v-if="isEdit" text-color="white"
      >编辑模式</v-chip
    >
      ...
      <template>
        ...
        <v-stepper-content step="1">
          <mavon-editor
            ...
            @imgAdd="$imgAdd"
          />
          <v-btn color="success" @click="nextStep()" style="margin-right:10px"
            >下一步</v-btn
          >
        ...
        <v-stepper-content step="2">
          ...
          <v-btn color="primary" @click="lastStep()" style="margin-right:10px"
            >上一步</v-btn
          >
          <v-btn color="success" @click="nextStep()" style="margin-right:10px"
            >下一步</v-btn
        ...
        <v-stepper-content step="3">
          ...
          <v-btn color="primary" @click="lastStep()" style="margin-right:10px"
            >上一步</v-btn
          >
          <v-btn color="success" @click="handle()" style="margin-right:10px"
            >完成</v-btn
          >
          <v-btn color="warning" @click="cancle()">取消</v-btn>
          <!-- <v-btn color="primary" @click="nextStep()">存入草稿</v-btn> -->
